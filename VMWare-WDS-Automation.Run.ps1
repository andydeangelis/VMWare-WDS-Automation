...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       9/11/2019 1:06 PM
...
"@ -IgnoreWarnings | Out-Null
	...
	$progressbarCreateVMs = New-Object 'SAPIENTypes.ProgressBarOverlay'
...
Cwg1RAAAOwAAAAAAAAAAAA==')
	...
	# tabpageStep6
	#
	$tabpageStep6.Controls.Add($progressbarCreateVMs)
	...
	#
	# progressbarCreateVMs
	#
	$progressbarCreateVMs.Location = '414, 20'
	$progressbarCreateVMs.Name = 'progressbarCreateVMs'
	$progressbarCreateVMs.Size = '75, 23'
	$progressbarCreateVMs.Style = 'Marquee'
	$progressbarCreateVMs.TabIndex = 8
	$progressbarCreateVMs.Visible = $False
	#
	...
	#
	$buttonBuildAndConfigureVMs.Location = '414, 151'
	$buttonBuildAndConfigureVMs.Name = 'buttonBuildAndConfigureVMs'
	$buttonBuildAndConfigureVMs.Size = '75, 93'
